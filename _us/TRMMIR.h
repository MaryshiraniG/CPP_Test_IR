...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996, 1997, 1998, 1999
                ...
                SID: 1.4
      Delta Created: 01/03/01 - 16:54:20
         Last Delta: app/src/common/InterfaceRecord/_us 3/1/01 - 16:54:20 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMMIR.h)
...
class CTRMMIR : public CMIR
{
   public:
      ...
      CTRMMIR() ;
      ~CTRMMIR() {cout << "OBJECT TRMMIR DESTROYED" << endl ;}

   private:
      void errorHandler() ;
		void createTRMMIR(CPNR 				  &po_PNR,
   							D_client_file_type  &pd_cfa_type,
   							D_client_file_code  &pd_cfa_code,
   							D_client_file_no    &pd_cfa_id,
   							D_person_name       &pd_last_name,
