...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996
      ...
      Delta Created: 14/11/04 - 14:29:54
         Last Delta: app/src/common/InterfaceRecord/_us 11/4/14 - 14:29:54 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMTAIR.cpp)
*/
#pragma comment ( copyright, "@(#)MATRIX{app/src/common/InterfaceRecord/_us}[11/4/14-14:29:54 1.18] /TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMTAIR.cpp (Ruma Sharma)\n" )
/*
...
void CTRMTAIR::processRMA(D_session_id &pd_sessionId,
...
//---------------------------------------------------------------------------------------------------------------------------
void CTRMTAIR::createTRMTAIR(CPNRWS				  &po_PNR,
   								D_client_file_type  &pd_cfa_type,
   								D_client_file_code  &pd_cfa_code,
   								D_client_file_no    &pd_cfa_id,
   								D_person_name       &pd_last_name,
...
//--------------------------------------------------------------------------------------------
void CTRMTAIR::initGirrawdetail(CGirrawdetailRead  &po_GirrawRead) 
{
...
void CTRMTAIR::saveSvcIrregularity()
{
   D_description   ld_errorDescription ;
   AB_Integer      li_msgId ;
