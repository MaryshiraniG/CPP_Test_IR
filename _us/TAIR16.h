...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996, 1997, 1998, 1999,
      ...
      Delta Created: 14/07/11 - 13:48:51
         Last Delta: app/src/common/InterfaceRecord/_us/ 7/11/14 - 13:48:51 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TAIR16.h) 
...
class CTAIR16 : public CInterfaceRecord
{
   public:
      void createCTAIR(CPNRWS &po_PNR)  ;
      void printAll() ;
		CTAIR16 () ; 
      ~CTAIR16() {cout << "OBJECT CTAIR16 DESTROYED" << endl ;}
   ...
   protected:
      ...
      V_AB_Varchar mv_IrTransData ;
		...
		void getMileage(AB_Varchar     &pv_field )  ;
		...
		void processTVLSegment(CPNRWS  &po_PNR) ;
		void processTVLTransport(V_AB_Varchar   &pv_arrayField,
