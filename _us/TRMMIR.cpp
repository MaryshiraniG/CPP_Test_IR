...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996
      ...
      SID: 1.28
      Delta Created: 16/03/09 - 15:44:52
    Last Delta: app/src/common/InterfaceRecord/_us 3/9/16 - 15:44:52 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMMIR.cpp) 
*/
#pragma comment ( copyright, "@(#)MATRIX{app/src/common/InterfaceRecord/_us}[3/9/16-15:44:52 1.28] /TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMMIR.cpp (unknown)\n" )
/*
...
CTRMMIR::CTRMMIR ()
{
   // LOG(logDEBUG) << "CREATE TRMTRMMIR OBJECT" << endl ;
}

void CTRMMIR::processRMA(D_session_id &pd_sessionId,
							...
							D_branch            &pd_cfaBra)
{
	...
	createTRMMIR(lo_PNR,pd_cfa_type,pd_cfa_code,pd_cfa_id,
...
//---------------------------------------------------------------------------------------------------------------------------
void CTRMMIR::createTRMMIR(CPNR 				  &po_PNR,
   								D_client_file_type  &pd_cfa_type,
   								D_client_file_code  &pd_cfa_code,
   								D_client_file_no    &pd_cfa_id,
   								D_person_name       &pd_last_name,
   								...
   								D_consultant        &pd_con_id)
{
   ...
   // LOG(logDEBUG) << "START TRMMIR PROCESSING" << endl ;

   // LOG(logDEBUG) << "START MIR PROCESSING" << endl ;
...
//--------------------------------------------------------------------------------------------
void CTRMMIR::initGirrawdetail(CGirrawdetailRead  &po_GirrawRead) 
{
...
void CTRMMIR::saveSvcIrregularity()
{
   D_description   ld_errorDescription ;
   AB_Integer      li_msgId ;
