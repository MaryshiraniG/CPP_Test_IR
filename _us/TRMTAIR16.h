...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996
                ...
                SID: 1.2
      Delta Created: 01/08/10 - 15:39:50
         Last Delta: app/src/common/InterfaceRecord/_us/ 8/10/01 - 15:39:50 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMTAIR16.h)
...
class CTRMTAIR16 : public CTAIR16
{
   public:
		void processRMA(D_session_id &pd_sessionId,
   						...
   						D_consultant        &pd_con_id,
							...
							D_branch            &pd_cfaBra) ;
      CTRMTAIR16() ;
      ~CTRMTAIR16() {cout << "OBJECT TRMTAIR DESTROYED" << endl ;}
