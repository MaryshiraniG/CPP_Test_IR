...
(c) Copyright GLOBAL Travel Computer Services 1994, 1995, 1996
      ...
      Delta Created: 14/11/04 - 14:29:54
         Last Delta: app/src/common/InterfaceRecord/_us 11/4/14 - 14:29:54 (/TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMTSS.cpp) 
*/
#pragma comment ( copyright, "@(#)MATRIX{app/src/common/InterfaceRecord/_us}[11/4/14-14:29:54 1.16] /TaskEnv/sw/app/src/common/InterfaceRecord/_us/s.TRMTSS.cpp (Ruma Sharma)\n" )
/*
...
CTRMTSS::CTRMTSS ()
{
   // LOG(logDEBUG) << "CREATE TRMTRMTSS OBJECT" << endl ;
}

void CTRMTSS::processRMA(D_session_id &pd_sessionId,
							...
							D_branch            &pd_cfaBra)
{
	...
	createTRMTSS(lo_PNR,pd_cfa_type,pd_cfa_code,pd_cfa_id,
...
//---------------------------------------------------------------------------------------------------------------------------
void CTRMTSS::createTRMTSS(CPNR 				  &po_PNR,
   								D_client_file_type  &pd_cfa_type,
   								D_client_file_code  &pd_cfa_code,
   								D_client_file_no    &pd_cfa_id,
   								D_person_name       &pd_last_name,
   								...
   								D_consultant        &pd_con_id)
{
   ...
   // LOG(logDEBUG) << "START TRMTSS PROCESSING" << endl ;
...
//--------------------------------------------------------------------------------------------
void CTRMTSS::initGirrawdetail(CGirrawdetailRead  &po_GirrawRead) 
{
...
void CTRMTSS::saveSvcIrregularity()
{
   D_description   ld_errorDescription ;
   AB_Integer      li_msgId ;
